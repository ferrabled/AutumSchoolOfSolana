...
export const UpdateCounter: FC = () => {
    ...
    const onClick = useCallback(async () => {
        ...
        try {  
            ...
            const tx = await program.rpc.updateCounter({                         
                accounts: {
            ...
            console.log("Counter Updated, added 1 to counter: " + counter.toString());
            notify({ type: 'success', message: 'Transaction successful!', txid:tx });
